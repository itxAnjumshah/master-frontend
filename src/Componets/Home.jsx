...
export default function Home() {
  ...
  return (
    <div className="font-[Poppins] relative w-full h-screen overflow-hidden">
      ...
      >
        <div
          className="w-full md:w-3/4 lg:w-1/2 p-6 sm:p-8 md:p-10 bg-white/10 backdrop-blur-md rounded-xl shadow-lg border border-white/20"
          data-aos="fade-up"
        >
          <h1
            className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold mb-4 sm:mb-6 text-yellow-400 drop-shadow-lg"
            data-aos="fade-down"
          >
            The Master Training Center
          </h1>
          <p
            className="text-base sm:text-lg md:text-xl lg:text-2xl mb-4 sm:mb-6 text-white font-semibold italic drop-shadow-lg transition-opacity duration-1000 ease-in-out"
            data-aos="fade-up"
          >
