  ...
  const handleSearchKeyPress = (e) => {
    if (e.key === 'Enter') {
      ...
      if (filteredCertificates.length === 0) {
        alert(`No certificates found for "${searchQuery}"`);
      }
    }
  };
            ...
            <div className="bg-white rounded-xl shadow-xl p-6 max-w-2xl w-full transform transition-all duration-300">
              ...
              <form onSubmit={(e) => { e.preventDefault(); handleUpdate(); }}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <label className="block text-gray-700 mb-2 font-medium">Father's Name</label>
                    <input
                      type="text"
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      value={editData.registrationNum}
                      onChange={(e) => setEditData({ ...editData, registrationNum: e.target.value })}
                      className="w-full p-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300"
                    />
                  </div>
                  <div>
                  ...
                  <div>
                    <label className="block text-gray-700 mb-2 font-medium">Center Name</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="block text-gray-700 mb-2 font-medium">Completion Date</label>
                    <input
                      type="date"
